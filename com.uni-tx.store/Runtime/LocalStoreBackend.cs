...
{
    /// <summary>
    /// Stores store progress on the device through the kit's serialisation service.
    /// </summary>
    /// <remarks>
    ...
    /// batch rather than the whole shop.
    /// </remarks>
    public sealed class LocalStoreBackend : IStoreBackend, IInjectable
    {
        ...
        public LocalStoreBackend(ISerialisationService serialisation) =>
