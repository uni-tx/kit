...
{
    /// <summary>
    /// Stores quest progress on the device through the kit's serialisation service.
    /// </summary>
    /// <remarks>
    ...
    /// batch rather than the whole board.
    /// </remarks>
    public sealed class LocalQuestsBackend : IQuestsBackend, IInjectable
    {
        ...
        public LocalQuestsBackend(ISerialisationService serialisation) =>
