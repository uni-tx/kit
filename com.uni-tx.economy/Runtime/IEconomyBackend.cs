...
{
    /// <summary>
    /// Where economy progress is stored.
    /// </summary>
    /// <remarks>
    /// <para>
    /// The seam that lets a game ship offline-first and add server authority later without
    /// touching a single call site. <see cref="LocalEconomyBackend"/> keeps everything on
    ...
    /// whether a purchase really happened.
    /// </para>
    /// </remarks>
    public interface IEconomyBackend
    {
        /// <summary>
        ...
        UniTask<EconomySavedData> LoadAsync(string saveId, CancellationToken cToken = default);
        ...
        /// an exchange or a purchase — and left clear for routine refreshes.
        /// </remarks>
        UniTask SaveAsync(EconomySavedData data, bool immediate, CancellationToken cToken = default);
    }
}
