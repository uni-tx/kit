...
{
    /// <summary>
    /// Stores economy progress on the device through the kit's serialisation service.
    /// </summary>
    /// <remarks>
    ...
    /// batch rather than the whole economy.
    /// </remarks>
    public sealed class LocalEconomyBackend : IEconomyBackend, IInjectable
    {
        ...
        public LocalEconomyBackend(ISerialisationService serialisation) =>
            ...
            CancellationToken cToken = default)
        {
            ...
            // checkpoint: a purchase lost to a crash is a support ticket, not a rounding error.
