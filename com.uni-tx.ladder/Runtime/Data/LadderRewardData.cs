...
{
    /// <summary>
    /// One reward a rung grants on claim.
    /// </summary>
    /// <remarks>
    /// The fields mirror the generic <see cref="RewardData"/> so the default granter can map
    /// the rung onto the kit's reward service without a translation table.
    /// </remarks>
    [Serializable]
    public sealed class LadderRewardData
    {
        [Tooltip("Unique reward id within the rung. Part of the idempotent grant id, so " +
                 "changing it on a live rung re-delivers the reward once.")]
        ...
        /// <summary>
        /// Gets the reward id, unique within the rung.
        /// </summary>
