...
{
    /// <summary>
    /// Stores ladder progress on the device through the kit's serialisation service.
    /// </summary>
    /// <remarks>
    ...
    /// batch rather than the whole climb.
    /// </remarks>
    public sealed class LocalLadderBackend : ILadderBackend, IInjectable
    {
        ...
        public LocalLadderBackend(ISerialisationService serialisation) =>
