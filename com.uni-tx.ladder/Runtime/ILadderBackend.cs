...
{
    /// <summary>
    /// Where ladder progress is stored.
    /// </summary>
    /// <remarks>
    /// <para>
    /// The seam that lets a game ship offline-first and add server authority later without
    /// touching a single call site. <see cref="LocalLadderBackend"/> keeps everything on the
    ...
    /// whether a claimed rung was really claimed.
    /// </para>
    /// </remarks>
    public interface ILadderBackend
    {
        /// <summary>
        ...
        UniTask<LadderSavedData> LoadAsync(string saveId, CancellationToken cToken = default);
        ...
        /// a claim — and left clear for routine step reports.
        /// </remarks>
        UniTask SaveAsync(LadderSavedData data, bool immediate, CancellationToken cToken = default);
    }
}
