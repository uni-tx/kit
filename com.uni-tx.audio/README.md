...
4. `https://github.com/uni-tx/kit.git?path=/com.uni-tx.pooling#pooling@1.2.0`
5. `https://github.com/uni-tx/kit.git?path=/com.uni-tx.audio#audio@1.2.0`

</details>

- **UniTx dependencies:** `com.uni-tx.ioc`, `com.uni-tx.core`, `com.uni-tx.pooling`
- **Unity registry dependencies** (resolved automatically): `com.unity.modules.audio`.
